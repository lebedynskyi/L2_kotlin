...
import com.vetalll.bridgenetwork.GameServerClientFactory
import com.vetalll.bridgenetwork.GameServerCrypt
import com.vetalll.bridgenetwork.packets.GameServerBridgePacketExecutor
...
class GameServer(
    ...
    fun connectToLoginServer() {
        clientSelector = SelectorClientThread(
            ...
            GameServerClientFactory(serverConfig.id, GameServerCrypt(serverConfig.loginBlowFishKey.toByteArray())),
            GameServerBridgePacketExecutor(world, Executors.newFixedThreadPool(1)) as PacketExecutor<Client<*, *>>,
            GameServerTag
        )
